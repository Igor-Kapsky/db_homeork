module.exports = class TestData {
    static query1 = {
        select: ['project.name AS projectName', 'test.name', 'MIN((test.end_time - test.start_time)) AS minDuration'],
        from: 'test',
    ...
    static query3 = {
        select: ['project.name AS projectName', 'test.name', 'test.start_time'],
        from: 'test',
        join: { table : 'project', column1: 'test.project_id', column2: 'project.id' },
